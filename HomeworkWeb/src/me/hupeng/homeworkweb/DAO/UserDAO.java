 ...
 * 
 * @see me.hupeng.homeworkweb.bean.User
...
public class UserDAO extends BaseHibernateDAO {
	...
	public static final String STU_NUM = "stuNum";
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getSession().get(
					"me.hupeng.homeworkweb.bean.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession()
					.createCriteria("me.hupeng.homeworkweb.bean.User")
	...
	public List findByStuNum(Object stuNum) {
		return findByProperty(STU_NUM, stuNum);
	}

	public List findByRegisterTime(Object registerTime) {
